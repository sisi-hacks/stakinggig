...
contract SeeseaToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    function withdrawTokens(uint256 amount, address token) external onlyOwner isSupported(token) {
    ...
    function getPrice() public view returns (uint256) {
        (uint256 roundId, int256 price,, uint256 updatedAt, uint80 answeredInRound) = bnbUsdPriceFeed.latestRoundData();
